...
import {
  changeBpm,
  changeExpandAfter,
  changeExpandBefore, changeSpeed, changeVolume, changeWait,
  moveSeek, selectCount, switchLoop,
  switchPlay,
  switchPlayBySeek, switchPlaySynth
...
const PopContent =()=> {
  ...
  //Counter()から外してみること。DOM更新時に、Popoverが非表示になるため。
